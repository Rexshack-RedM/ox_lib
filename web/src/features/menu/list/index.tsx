...
const useStyles = createStyles((theme, params: { position?: MenuPosition; itemCount: number; selected: number }) => ({
  ...
  container: {
    ...
    fontFamily: '"RDR Lino Regular", serif',
    width: 384,
    background: `url(${import.meta.env.DEV ? '/src/assets/large_weathered_paper.png' : './assets/large_weathered_paper.png'})`,
    backgroundSize: '100% 100%',
    backgroundRepeat: 'no-repeat',
    padding: '20px',
  ...
  scrollArrow: {
    background: `url(${import.meta.env.DEV ? '/src/assets/selection_box_bg_1d.png' : './assets/selection_box_bg_1d.png'})`,
    backgroundSize: '100% 100%',
    backgroundRepeat: 'no-repeat',
    textAlign: 'center',
    borderRadius: 0,
